...
TYPE1="cot"
TYPE2="baseline"
# gpt-oss has 24 layers (0-23), testing mid-to-late layers
TRY_LAYERS="7,9,11,13,15,17,19"

# Print what CUDA devices are available as list - e.g. 0,1,2,3
...
LOG_FILE="${LOG_DIR}/gpt_oss_experiment_${TIMESTAMP}.log"
