...
# Number of high variance prompts to randomly sample
N=32
...
LOG_FILE="${LOG_DIR}/resample_quadrant_${TIMESTAMP}.log"
...
for i in "${!MODEL_NAMES[@]}"; do
    ...
    uv run -m utils.heuristic.resample_quadrants --model_name "$MODEL_NAME" --repetitions $REPETITION --x_threshold $X_TSHLD --y_threshold $Y_TSHLD --n $N
